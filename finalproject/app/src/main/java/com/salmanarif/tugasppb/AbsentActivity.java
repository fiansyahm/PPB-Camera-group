    ...
    public void uploadToServer(){
        ...
        call.enqueue(new Callback<Response>() {
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                Toast.makeText(AbsentActivity.this, "Upload Sukses", Toast.LENGTH_SHORT).show();
...
//                }
            ...
            public void onFailure(Call<Response> call, Throwable t) {
                Toast.makeText(AbsentActivity.this, "Upload Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showAlert() {
        AlertDialog alertDialog = new AlertDialog.Builder(AbsentActivity.this).create();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "ALLOW",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        ActivityCompat.requestPermissions(AbsentActivity.this,
                ...
                for (int i = 0, len = permissions.length; i < len; i++) {
                    ...
                    if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                        ...
                        if (showRationale) {
                            ...
                            // the app setting
                            saveToPreferences(AbsentActivity.this, ALLOW_KEY, true);
                        }
                    }
                }
            }
